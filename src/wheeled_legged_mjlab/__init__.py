...
register_mjlab_task(
    task_id="Mjlab-Velocity-Rough-WF-Tron1B-Recovery",
    env_cfg=wf_tron1b_rough_recovery_env_cfg(),
    play_env_cfg=wf_tron1b_rough_recovery_env_cfg(play=True),
    rl_cfg=wf_tron1b_ppo_runner_cfg(),
    runner_cls=WheeledLeggedVelocityOnPolicyRunner,
)
...
register_mjlab_task(
    ...
    env_cfg=wf_tron1b_rough_rep_ts_lin_vel_depth_recovery_env_cfg(),
    play_env_cfg=wf_tron1b_rough_rep_ts_lin_vel_depth_recovery_env_cfg(
        play=True
    ),
    rl_cfg=wf_tron1b_rep_ts_lin_vel_depth_predict_runner_cfg(),
    runner_cls=WheeledLeggedVelocityOnPolicyRunner,
