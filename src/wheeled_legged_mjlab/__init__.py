...
from wheeled_legged_mjlab.tasks.velocity.config.wf_tron1b.rl_cfg import (
    ...
    wf_tron1b_vision_cts_runner_cfg,
)
...
register_mjlab_task(
    task_id="Mjlab-Velocity-Rough-WF-Tron1B-Vision-CTS",
    env_cfg=wf_tron1b_rough_vision_cts_env_cfg(),
    play_env_cfg=wf_tron1b_rough_vision_cts_env_cfg(play=True),
    rl_cfg=wf_tron1b_vision_cts_runner_cfg(),
    runner_cls=WheeledLeggedVelocityOnPolicyRunner,
)
